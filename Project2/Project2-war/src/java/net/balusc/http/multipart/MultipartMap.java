...
public class MultipartMap extends HashMap<String, Object> {
     ...
     * servlet associated with the request. The file upload location will be
     * extracted from <code>@MultipartConfig</code> of the servlet. When the
     * encoding is not specified in the given request, then it will default to
     * <tt>UTF-8</tt>.
     *
     * @param multipartRequest The multipart request to construct the multipart
     * map for.
